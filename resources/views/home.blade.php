...
<head>
    ...
    <title>Trang chủ - Football Booking</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet">
    <style>
        .feature-box:hover { background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); }
        .feature-box { background: #ffffff; border-radius: 20px; padding: 30px; margin-bottom: 30px; box-shadow: 0 10px 25px rgba(0,0,0,0.08); transition: all 0.3s ease; text-align: left; }
        .feature-box:hover { transform: translateY(-8px); box-shadow: 0 15px 30px rgba(0,0,0,0.12); }
        .feature-icon { width: 70px; height: 70px; border-radius: 50%; color: #fff; font-size: 28px; display: flex; align-items: center; justify-content: center; margin-bottom: 15px; }
        .bg-blue   { background: #3f8efc; }
        .bg-yellow { background: #f3c63f; }
        .bg-orange { background: #ff8a3d; }
        .bg-green  { background: #3ecf8e; }
        .feature-title { font-size: 22px; font-weight: 700; margin-bottom: 10px; color: #333; }
        .feature-text { color: #666; font-size: 15px; line-height: 1.6; }
        .feature-box button { border-radius: 30px; padding: 6px 20px; }
        .jumbotron { background-image: url('{{ asset("assets/images/2340596.jpg") }}') !important; background-size: cover; }
    </style>
</head>
<body>
